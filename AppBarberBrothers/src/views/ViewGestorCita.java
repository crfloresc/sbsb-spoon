...
public class ViewGestorCita extends javax.swing.JFrame {
    ...
    private void btnAgregarCitaActionPerformed(java.awt.event.ActionEvent evt) {                                               
        ...
        if (confirm == javax.swing.JOptionPane.YES_OPTION) {
            ...
            Servicios s = new Servicios(cbServicios.getSelectedIndex() + 1, cbServicios.getSelectedItem().toString(), 70, 45);
            System.out.println(b+","+c+","+f+","+s);
            /**
             * Controlador de agregar cita
             */
            boolean resultado = ViewMenuCitas.controlCitas.agregar(ViewMenuCitas.controlCitas.listar().size(), f, b, c, s);
            if(resultado == false) {
                JOptionPane.showMessageDialog(this, 
                        "Lo sentimos, la hora que seleccionó no está disponible para el barbero seleccionado", 
                        "Cita no agregada", 
                        JOptionPane.INFORMATION_MESSAGE);                
            } else {
                JOptionPane.showMessageDialog(this, 
                        "La cita ha sido agregada correctamente", 
                        "Cita agregada", 
                        JOptionPane.INFORMATION_MESSAGE);
            }
