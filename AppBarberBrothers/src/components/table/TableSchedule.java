...
public class TableSchedule extends JTable {
    ...
    public TableSchedule(List lista) {
        super(new ScheduleTableModel(lista));
        initDefault();
    }
    
    public TableSchedule(int type) {
        super(new ScheduleTableModel(type));
        initDefault();
    }
    
    public TableSchedule(int type, List lista) {
        super(new ScheduleTableModel(type, lista));
        initDefault();
    }
